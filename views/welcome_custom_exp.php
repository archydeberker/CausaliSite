...
$args = "'register_user_experiment' $temp1 $temp2 $temp3 $temp4 $temp5 $temp6 $temp7 $temp8 $temp9 $temp10 $temp11 $temp12";
$command = "python ../php_to_python.py " . escapeshellarg($args);
exec($command);
?>
